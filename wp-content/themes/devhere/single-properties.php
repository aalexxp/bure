...
//                    var_dump($prop_street_file);
                    ...
                    <article>
                        ...
                        <table style="border: 1px solid black">
                            <tr><td>Property Number</td><td><?php echo $prop_number ?></td></tr>
                            <tr><td>Property Street</td><td><?php echo (!empty($prop_street_file)) ? '<a href="' . $prop_street_file . '">Open Pdf</a>' : $prop_street; ?></td></tr>
                            <tr><td>Property Suburb</td><td><?php echo $prop_suburb ?></td></tr>
                            <tr><td>Lot #</td><td><?php echo (!empty($prop_lot_file)) ? '<a href="' . $prop_lot_file . '">Open Pdf</a>' : $prop_lot; ?></td></tr>
                            <tr><td>RP/SP</td><td><?php echo (!empty($prop_rpsp_file)) ? '<a href="' . $prop_rpsp_file . '">Open Pdf</a>' : $prop_rpsp; ?></td></tr>
                            ...
                            <tr><td>Link to Ad</td><td><?php echo $prop_ad_link ?></td></tr>
                            ...
                            <tr><td>Zoning</td><td><?php foreach ($prop_zoning as $zone) echo $zone . ' '; ?></td></tr>
                            ...
                            <tr><td>Pre-1911 House</td><td><?php echo (!empty($prop_pre_1911_file)) ? '<a href="' . $prop_pre_1911_file . '">Open Pdf</a>' : $prop_pre_1911; ?></td></tr>
                            <tr><td>Heritage</td><td><?php echo (!empty($prop_heritage_file)) ? '<a href="' . $prop_heritage_file . '">Open Pdf</a>' : $prop_heritage; ?></td></tr>
                            ...
                            <tr><td>Aerial Map Link</td><td><?php echo $prop_area_map ?></td></tr>
                            <tr><td>PD Online link</td><td><?php echo $prop_pd_link ?></td></tr>
                            <tr><td>Contour link</td><td><?php echo $prop_countour_link ?></td></tr>
                            <tr><td>Sewer and water link</td><td><?php echo $prop_sewer_link ?></td></tr>
                            <tr><td>Stormwater link</td><td><?php echo $prop_storm_link ?></td></tr>
                            ...
                            <tr>Biodiversity<td></td><td><?php echo $prop_biodiversity ?></td></tr>
